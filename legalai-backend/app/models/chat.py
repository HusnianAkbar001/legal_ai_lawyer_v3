...
#     ):
#         """
#         Append a message to a conversation while keeping only the latest N messages
#         for that conversation. This matches your requirement:
#         "each chat stores latest 100 messages, older auto-deleted."
#         """
#         db.session.add(
#             ChatMessage(
#                 user_id=user_id,
